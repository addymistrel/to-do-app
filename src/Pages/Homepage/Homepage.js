...
function Homepage() {
  ...
  return (
    <>
      <div>
        <Navbar isBordered isBlurred={false} className="bg-[#333]">
          <NavbarBrand>
            <Image src="/logo.png" alt="logo" width={50} />
            <h1 class="bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-teal-500 text-3xl font-black pl-2  ">
              To-Do
            </h1>
          </NavbarBrand>
            ...
            <div class="container mx-auto px-8 lg:flex">
              <div class="text-center lg:text-left lg:w-1/2">
                <h1 class="text-4xl lg:text-5xl xl:text-6xl font-bold leading-none">
                  Track and Streamline your activity
                </h1>
                <p class="text-xl lg:text-2xl mt-6 font-light">
                  An intuitive todo website to organize tasks, track progress,
                  and boost your efficiency effortlessly.
                </p>
                <p class="mt-8 md:mt-12">
                  <button
                    type="button"
                    class=" py-4 px-12 bg-[#006fee] hover:bg-[#333] rounded text-white"
                    onClick={() => setSignupOpen(true)}
                  >
                    Get Started
                  </button>
